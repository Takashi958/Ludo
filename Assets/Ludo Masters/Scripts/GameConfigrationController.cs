...
public class GameConfigrationController : MonoBehaviour
{
    ...
    public void CheckPremiumRoom()
    {
        if (initMenuScript.isPremiumMember)
        {
        ...
        {
            initMenuScript._NotPremiumNotificationPanel.SetActive(true);
            initMenuScript._NotPremiumNotificationPanel.transform.DOScale(new Vector3(1, 1, 1), 0.5f);
        }
    }
